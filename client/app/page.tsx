  ...
  return (
    <div className="flex flex-col w-full h-full items-center">
      <div className="flex flex-col lg:flex-row w-full min-h-screen">
        ...
        <div className="flex flex-col pt-16 pb-5 lg:pb-0 md:pt-24 md:pl-20 lg:pl-0 items-start w-full px-10 lg:px-0 lg:w-2/5">
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <div className="text-black w-72 rounded-full flex justify-center items-center gap-2 font-bold cursor-pointer hover:bg-slate-100 overflow-hidden">
              <GoogleLogin
                text={"signup_with"}
                shape="pill"
                width={800}
            ...
            <div className="bg-white w-72 text-black p-1 py-2 rounded-full flex justify-center items-center gap-2  font-bold cursor-not-allowed hover:bg-slate-100">
              <span className="text-xl">
                <FaApple />
              </span>
              <span>Sign up with Apple</span>
            </div>
            <div className="w-72 text-white p-1 py-2 flex justify-center items-center gap-2  font-bold cursor-not-allowed">
              <div className="flex-1 border-slate-700 border-t-[0.5px] "></div>
              or
              <div className="flex-1 border-slate-700 border-t-[0.5px]"></div>
            </div>
            <div className="bg-sky-500 hover:bg-sky-600 w-72 text-white p-1 py-2 rounded-full flex justify-center items-center gap-2  font-bold tracking-wider cursor-not-allowed">
              Sign up with email or phone
            </div>
            <div className=" w-80 p-1 py-2 rounded-full justify-center items-center gap-2 text-xs text-gray-600 cursor-not-allowed tracking-wide">
            ...
            <div className="w-72 text-white p-1 py-2 rounded-fullgap-2 mt-5  font-bold">
              Already have an account?
            </div>
            <div className="w-72 text-sky-600 border-slate-700 border-[0.5px] p-1 py-2 rounded-full flex justify-center items-center gap-2  font-bold tracking-wider cursor-not-allowed">
              Sign in
            </div>
          </div>
        </div>
