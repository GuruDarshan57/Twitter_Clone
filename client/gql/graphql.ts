...
export type GetCurrentUserDataQuery = { __typename?: 'Query', getCurrentUserData?: { __typename?: 'User', id: string, email: string, firstName: string, lastName?: string | null, profileImgUrl: string } | null };
